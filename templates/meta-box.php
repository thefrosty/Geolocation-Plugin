...
<div id="geolocation-map"
     style="border:solid 1px #c6c6c6;width:265px;height:200px;margin-top:5px;"></div>
...
<input type="hidden" id="geolocation_nonce" name="geolocation_nonce"
       value="<?php wp_create_nonce( plugin_basename( GEOLOCATION__FILE ) ); ?>"/>